 ...
 *
 * High-level service that ties together prompt-builder and puter-client
 ...
 * 2. Calls Puter.js text generation
 ...
 *
 * 1. Builds an image prompt with brand colors/style + SA visual cues
 * 2. Calls Puter.js image generation
 * 3. Returns the image data URL with dimensions
 */
 ...
 *
 * 1. Builds a video prompt with format instructions + SA context
 * 2. Calls Puter.js video generation
 * 3. Returns the video URL with dimensions
 */
