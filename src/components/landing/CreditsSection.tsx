  ...
  return (
    <section className="py-20">
      <div className="mx-auto w-full max-w-[1240px] px-4 sm:px-8">
        <div className="bg-surface-raised border border-border rounded-lg p-8 sm:p-14 flex flex-col lg:flex-row items-center justify-between gap-12 relative overflow-hidden">
          {/* Background glow */}
          ...
          <div className="flex-1 relative z-[1] text-center lg:text-left">
            ...
            <p className="text-sm text-text-secondary leading-[1.7] font-light mb-6">
              {t('description')}
            </p>
          ...
          <div className="relative z-[1]">
            <span className="block mb-3.5 text-[10px] font-semibold tracking-[3px] uppercase text-text-muted text-center lg:text-right">
              {t('checkoutLabel')}
            </span>
            <div className="flex flex-col sm:flex-row gap-3.5 mb-4">
              <div className="bg-surface-inset border border-border rounded-md px-7 py-5 text-center hover:border-brand transition-colors duration-300 cursor-pointer">
                <div className="text-[11px] font-semibold text-text-muted tracking-[0.5px] mb-1">
                  {t('smallAmount')}
                </div>
