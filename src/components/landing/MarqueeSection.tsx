...
export function MarqueeSection() {
  ...
  return (
    <section className="py-7 border-t border-b border-border overflow-hidden relative">
      {/* Fade edges */}
      ...
      <div className="flex w-max animate-[landing-marquee_35s_linear_infinite]">
        {repeatedItems.map((text, i) => (
          <span
            key={`${text}-${i}`}
            className="flex items-center gap-10 px-10 whitespace-nowrap text-[13px] font-normal tracking-[1.5px] text-text-muted"
          >
