    ...
    >
      ...
      <div className="flex flex-col gap-1">
        ...
        <input
          ...
          className={cn(
            'h-9 w-full rounded-lg border border-border bg-surface-inset px-3 text-sm text-text',
      ...
      <div className="flex flex-col gap-1">
        ...
        <input
          ...
          disabled={status === 'submitting'}
          className={cn(
            'h-9 w-full rounded-lg border bg-surface-inset px-3 text-sm text-text',
            'placeholder:text-text-muted outline-none',
            'focus:border-brand',
            'disabled:opacity-50',
      ...
      <div className="flex flex-col gap-1">
        ...
        <textarea
          ...
          rows={3}
          className={cn(
            'w-full resize-none rounded-lg border border-border bg-surface-inset px-3 py-2 text-sm text-text',
            'placeholder:text-text-muted outline-none',
            'focus:border-brand',
            'disabled:opacity-50',
            'leading-relaxed',
      ...
      {status === 'error' && errorMessage && (
        <p className="rounded-lg bg-error-surface px-3 py-2 text-xs text-error">
          {errorMessage}
        </p>
      )}
      ...
      <div className="flex items-center gap-2">
        ...
        <button
          ...
          disabled={status === 'submitting'}
          className={cn(
            'rounded-lg px-4 py-2 text-sm text-text-muted',
