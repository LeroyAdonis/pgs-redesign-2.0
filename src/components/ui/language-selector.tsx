  ...
  return (
    <div ref={dropdownRef} className="relative inline-block text-left">
      <button
        ...
        disabled={isPending}
        className="inline-flex items-center gap-2 rounded-none border border-border bg-surface-raised px-3 py-2 text-sm font-medium text-text shadow-sm transition-colors hover:bg-surface-raised/80 disabled:opacity-50"
      ...
      {isOpen && (
        <div
          className="absolute right-0 z-50 mt-2 max-h-80 w-56 overflow-y-auto rounded-none border border-border bg-surface-raised shadow-lg"
          role="listbox"
          aria-label={t("selectLanguage")}
        >
          <div className="py-1">
