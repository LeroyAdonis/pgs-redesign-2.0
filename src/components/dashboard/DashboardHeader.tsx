      ...
      <div className="flex items-center gap-2 sm:gap-3">
        ...
        <div ref={userMenuRef} className="relative">
          <button
            ...
            className="flex items-center gap-2 rounded-lg p-1.5 transition-colors hover:bg-brand-surface"
            aria-haspopup="menu"
          ...
          {userMenuOpen && (
            <div
              className="absolute right-0 z-50 mt-2 w-56 rounded-lg border border-border bg-surface-raised py-1 shadow-lg"
              role="menu"
