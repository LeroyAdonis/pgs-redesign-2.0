  ...
  const sidebarContent = (
    <>
      ...
      <div className="flex h-14 shrink-0 items-center gap-2 border-b border-border px-5">
        <div className="flex h-8 w-8 items-center justify-center rounded-none bg-brand-surface">
          <svg
                ...
                return (
                  <li key={item.labelKey}>
                    <Link
                      href={item.href}
                      className={cn(
                        "relative flex items-center gap-3 rounded-none px-2 py-2 text-[0.8125rem] font-medium transition-colors duration-150",
                        active
  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed left-4 top-4 z-[201] flex h-10 w-10 items-center justify-center rounded-none border border-border bg-surface text-text-muted shadow-sm transition-colors hover:text-text md:hidden"
      ...
      >
        ...
        <button
          ...
          onClick={closeMobile}
          className={cn(
            "absolute right-3 top-4 flex h-8 w-8 items-center justify-center rounded-none text-text-muted transition-colors hover:text-text md:hidden",
            !mobileOpen && "hidden",
          )}
