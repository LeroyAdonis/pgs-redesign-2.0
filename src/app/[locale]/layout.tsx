  ...
  return (
    <html lang={locale} suppressHydrationWarning>
      ...
      >
        ...
        <a
          href="#main-content"
          className="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 focus:z-[500] focus:bg-brand focus:text-white focus:px-4 focus:py-2 focus:rounded-lg focus:outline-none"
        >
