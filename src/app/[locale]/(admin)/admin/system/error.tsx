/**
 * System health error boundary
 *
 * Catches errors in the system health page and shows a recovery UI.
...
export default function SystemHealthError({ error, reset }: SystemErrorProps) {
  useEffect(() => {
    ...
    <div className="flex min-h-[50vh] items-center justify-center p-4">
      <div className="w-full max-w-md rounded-xl border border-red-500/20 bg-slate-900/50 p-6 text-center">
        ...
        <p className="mt-2 text-sm text-slate-400">
          Unable to load system health data. The monitoring service may be
