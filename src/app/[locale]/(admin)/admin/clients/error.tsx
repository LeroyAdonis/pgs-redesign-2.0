/**
 * Admin clients error boundary
 *
 * Catches errors in the clients page and displays a recovery UI.
 * Matches the admin error boundary pattern from the overview page.
 */
...
export default function AdminClientsError({ error, reset }: ClientsErrorProps) {
  useEffect(() => {
    ...
    <div className="flex min-h-[50vh] items-center justify-center p-4">
      <div className="w-full max-w-md rounded-xl border border-red-500/20 bg-slate-900/50 p-6 text-center">
        ...
        <p className="mt-2 text-sm text-slate-400">
          An error occurred while loading the client management page. This has
