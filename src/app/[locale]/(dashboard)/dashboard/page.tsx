    ...
    <div className="mx-auto max-w-6xl space-y-6">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <Link
          ...
          className="inline-flex shrink-0 items-center justify-center gap-2 rounded-none bg-brand px-5 h-10 text-sm font-medium text-white shadow-sm transition-all hover:bg-brand-vivid hover:shadow-glow focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand"
        >
          <PlusIcon />
          {t("createPost")}
        </Link>
