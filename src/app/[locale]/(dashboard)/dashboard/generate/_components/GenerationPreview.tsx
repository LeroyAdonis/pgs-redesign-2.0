      ...
      <div className="flex flex-col gap-4">
        <div className="rounded-xl border border-border bg-surface p-6" data-testid="generation-text-result">
          {isEditing ? (
            <textarea
              ...
              className="w-full resize-none rounded-lg border border-border bg-surface-raised p-3 text-sm text-text focus:border-brand focus:outline-none focus:ring-1 focus:ring-brand"
              rows={8}
        ...
        <div className="flex flex-wrap items-center gap-2">
          <button
            ...
            className="rounded-lg border border-border px-3 py-1.5 text-xs font-medium text-text-muted transition-colors hover:text-text"
          >
          ...
          <button
            ...
            disabled={isSaving}
            className={cn(
              "rounded-lg bg-brand px-3 py-1.5 text-xs font-medium text-white transition-colors hover:bg-brand/90",
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <button
            ...
            disabled={isSaving}
            className={cn(
              "rounded-lg border border-border px-3 py-1.5 text-xs font-medium text-text-muted transition-colors hover:text-text",
              "disabled:cursor-not-allowed disabled:opacity-50",
            )}
          >
            {isSaving ? "Saving..." : "Save as Draft"}
